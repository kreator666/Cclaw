...
### v1.3.0 (2026-04-24)
- 新增视频剪辑模块（FFmpeg 工作流 + 3 个配方 + 过渡效果库）
- cases 案例库整合进创作流程（模板→cases→理论强制顺序）
- 修正 Call Back 定义（遗忘后再炸，非呼应回归）
- 完善 7 种喜剧模板
- 新增创作方法论索引
- 许可证从 CC BY-NC 4.0 变更为 MIT-0

### v1.0.0 (2026-04-19)
- 初始发布：7 种喜剧类型输出模板 + 4 篇理论文档
- 喜剧理论体系完整（核心原理/包袱结构/心理学/类型速查）
- 知识库去名化处理
- 发布至 ClawHub
