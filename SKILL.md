...
- ❌ **正文中禁止出现**：理论家人名（柏格森、弗洛伊德、康德、斯宾塞等）、书名/论文标题（《笑》《笑话及其与无意识的关系》等）、理论术语标签（"弹簧魔鬼""雪球效应""压抑-释放"等）、经典角色名（堂吉诃德、阿巴贡、塔图菲等）
...
| 知识文件 | 内容 |
|---------|------|
| `knowledge/theory/bergson.md` | 核心理论（必读） |
| `knowledge/theory/xiangsheng.md` | 相声包袱结构 |
| `knowledge/theory/freud.md` | 笑的释放机制 |
